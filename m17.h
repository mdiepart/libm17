...
void conv_encode_bert_frame(uint8_t out[SYM_PER_PLD*2], const uint8_t in[26]);
...
#define M17_CONSTR_LEN	5		                       //constraint length
#define NUM_STATES	    (1 << (M17_CONSTR_LEN - 1))    //number of states
